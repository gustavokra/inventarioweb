...
export default function PDV() {
    ...
    const fetchClientes = async () => {
        try {
            const response = await fetch('https://localhost:8443/api/v1/client', {
                method: 'GET',
                headers: {
    ...
    const fetchProdutos = async () => {
        try {
            const response = await fetch('https://localhost:8443/api/v1/product', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
    ...
    const fetchFormasPagamento = async () => {
        try {
            const response = await fetch('https://localhost:8443/api/v1/forma-pagamento', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
    ...
    const fetchOperacoes = async () => {
        try {
            const response = await fetch('https://localhost:8443/api/v1/operacao-caixa', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
    ...
    const handleFinalizarVenda = async () => {
        ...
        try {
            const response = await fetch('https://localhost:8443/api/v1/order', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
