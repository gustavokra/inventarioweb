...
export default function ProductCadaster() {
    ...
    const fetchMarcas = async () => {
        try {
            const response = await fetch('https://inventario-web-ptax.onrender.com/api/v1/marca', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
    ...
    const fetchGrupos = async () => {
        try {
            const response = await fetch('https://inventario-web-ptax.onrender.com/api/v1/grupo', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
