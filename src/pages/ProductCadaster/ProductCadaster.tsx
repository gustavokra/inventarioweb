...
export default function ProductCadaster() {
    ...
    const fetchMarcas = async () => {
        try {
            const response = await fetch('https://inventarioweb-seven.vercel.app/api/v1/marca', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
    ...
    const fetchGrupos = async () => {
        try {
            const response = await fetch('https://inventarioweb-seven.vercel.app/api/v1/grupo', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
    ...
    const registerProduct = async (prodcutDataToRegister: IProduct) => {
        try {
            const response = await fetch('https://inventarioweb-seven.vercel.app/api/v1/product', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'dbImpl': 'SQLITE',
